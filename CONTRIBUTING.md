...
**Any contribution helps our team and make HBAT better for the entire community!**

Everybody is welcome and invited to contribute to the HBAT Project by:

* Testing newly released features and reporting issues.
* Providing Pull Requests (Features, Proof of Concepts, Language files or Fixes)
* Contributing missing documentation for features and devices in our [documentation](https://HBAT.github.io/docs/Contributing)
...
3. Questions of type "How do I..." or "Can you please help me with..." or "Can HBAT do..." WILL NOT be handled here. Such questions should be directed at a discussion forum or to the HBAT Support Chat. All issues of this type will be closed with a simple reference to this contributing policy.
...
* Fork the HBAT Repository [git repository](https://github.com/Prometheon-Technologies/HBAT-Software).
* Write/Change the code in your Fork for a new feature, bug fix, new sensor, optimization, etc.
* Ensure tests work.
* Create a Pull Request against the [**development**](https://github.com/Prometheon-Technologies/HBAT-Software/tree/dev) branch of HBAT.
